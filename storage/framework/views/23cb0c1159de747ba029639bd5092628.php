...
<?php $__env->startSection('title', 'Modifier fidèle'); ?>
...
<div class="max-w-5xl mx-auto space-y-4">
    ...
    <div class="flex items-center gap-3">
        ...
        <a href="<?php echo e(route('believers.show', $believer)); ?>"
           class="text-sm text-gray-500 hover:text-gray-700"><?php echo e($believer->full_name); ?></a>
        <span class="text-gray-300">/</span>
        <span class="text-sm text-gray-700 font-medium">Modifier</span>
            ...
            <form method="POST" action="<?php echo e(route('believers.update', $believer)); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?> 
                ...
                <div id="panel-general" class="tab-panel bg-white shadow-sm rounded-lg p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" value="<?php echo e($believer->register_number); ?>" disabled
                        ...
                        <div>
                            ...
                            <input type="text" name="lastname" value="<?php echo e(old('lastname', $believer->lastname)); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="firstname" value="<?php echo e(old('firstname', $believer->firstname)); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select name="gender" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                                <option value="M" <?php if(old('gender', $believer->gender) === 'M'): echo 'selected'; endif; ?>>Homme</option>
                                <option value="F" <?php if(old('gender', $believer->gender) === 'F'): echo 'selected'; endif; ?>>Femme</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="marital_status" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                                ...
                                <option value="celibataire" <?php if(old('marital_status', $believer->marital_status) === 'celibataire'): echo 'selected'; endif; ?>>Célibataire</option>
                                <option value="marie"       <?php if(old('marital_status', $believer->marital_status) === 'marie'): echo 'selected'; endif; ?>>Marié(e)</option>
                                <option value="veuf"        <?php if(old('marital_status', $believer->marital_status) === 'veuf'): echo 'selected'; endif; ?>>Veuf/Veuve</option>
                                <option value="divorce"     <?php if(old('marital_status', $believer->marital_status) === 'divorce'): echo 'selected'; endif; ?>>Divorcé(e)</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="date" name="birth_date"
                                value="<?php echo e(old('birth_date', $believer->birth_date?->format('Y-m-d'))); ?>"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700">Lieu de naissance</label>
                            <input type="text" name="birth_place" value="<?php echo e(old('birth_place', $believer->birth_place)); ?>"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700">Nationalité</label>
                            <input type="text" name="nationality" value="<?php echo e(old('nationality', $believer->nationality)); ?>"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700">Numéro CNI</label>
                            <input type="text" name="cni_number" value="<?php echo e(old('cni_number', $believer->cni_number)); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" name="number_of_children" min="0"
                                value="<?php echo e(old('number_of_children', $believer->number_of_children)); ?>"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-3 mt-2 mb-2">
                                <img src="<?php echo e($believer->profile_picture_url); ?>" alt="Photo actuelle"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div id="panel-adresse" class="tab-panel hidden bg-white shadow-sm rounded-lg p-6">
                    ...
                    <?php $addr = $believer->address; ?>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Commune</label>
                            <input type="text" name="address[commune]" value="<?php echo e(old('address.commune', $addr?->commune)); ?>"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Quartier</label>
                            <input type="text" name="address[quartier]" value="<?php echo e(old('address.quartier', $addr?->quartier)); ?>"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Sous-quartier</label>
                            <input type="text" name="address[sous_quartier]" value="<?php echo e(old('address.sous_quartier', $addr?->sous_quartier)); ?>"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Téléphone</label>
                            <input type="text" name="address[phone]" value="<?php echo e(old('address.phone', $addr?->phone)); ?>"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">WhatsApp</label>
                            <input type="text" name="address[whatsapp]" value="<?php echo e(old('address.whatsapp', $addr?->whatsapp)); ?>"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Email</label>
                            <input type="email" name="address[email]" value="<?php echo e(old('address.email', $addr?->email)); ?>"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                    </div>
                </div>
                ...
                <div id="panel-eglise" class="tab-panel hidden bg-white shadow-sm rounded-lg p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="church[connaissance_eglise]" value="<?php echo e(old('church.connaissance_eglise', $ci?->connaissance_eglise)); ?>"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Église d'origine</label>
                            <input type="text" name="church[original_church]" value="<?php echo e(old('church.original_church', $ci?->original_church)); ?>"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Année d'arrivée</label>
                            <input type="number" name="church[arrival_year]" value="<?php echo e(old('church.arrival_year', $ci?->arrival_year)); ?>"
                                min="1900" max="<?php echo e(date('Y')); ?>"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Date de conversion</label>
                            <input type="date" name="church[conversion_date]" value="<?php echo e(old('church.conversion_date', $ci?->conversion_date?->format('Y-m-d'))); ?>"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Lieu de conversion</label>
                            <input type="text" name="church[conversion_place]" value="<?php echo e(old('church.conversion_place', $ci?->conversion_place)); ?>"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        <div class="md:col-span-2">
                            <label class="flex items-center gap-2 text-sm font-medium text-gray-700 cursor-pointer">
                                <input type="checkbox" name="church[baptised]" value="1"
                                    <?php if(old('church.baptised', $ci?->baptised)): echo 'checked'; endif; ?>
                                    class="rounded border-gray-300 text-indigo-600"
                                    onchange="toggleBaptism(this)">
                                Baptisé(e)
                            </label>
                        </div>
                        <div id="baptism-fields" class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4 <?php echo e(old('church.baptised', $ci?->baptised) ? '' : 'hidden'); ?>">
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Date de baptême</label>
                                <input type="date" name="church[baptism_date]" value="<?php echo e(old('church.baptism_date', $ci?->baptism_date?->format('Y-m-d'))); ?>"
                                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Lieu de baptême</label>
                                <input type="text" name="church[baptism_place]" value="<?php echo e(old('church.baptism_place', $ci?->baptism_place)); ?>"
                                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Pasteur officiant</label>
                                <input type="text" name="church[baptism_pastor]" value="<?php echo e(old('church.baptism_pastor', $ci?->baptism_pastor)); ?>"
                                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">N° carte de baptême</label>
                                <input type="text" name="church[baptism_card_number]" value="<?php echo e(old('church.baptism_card_number', $ci?->baptism_card_number)); ?>"
                                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                            </div>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <select name="education[niveau_etude]" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                                ...
                                <?php $__currentLoopData = ['Primaire','Secondaire','Baccalauréat','Licence','Master','Doctorat','Aucun']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($n); ?>" <?php if(old('education.niveau_etude', $edu?->niveau_etude) === $n): echo 'selected'; endif; ?>><?php echo e($n); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Diplôme obtenu</label>
                            <input type="text" name="education[diploma]" value="<?php echo e(old('education.diploma', $edu?->diploma)); ?>"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Qualification</label>
                            <input type="text" name="education[qualification]" value="<?php echo e(old('education.qualification', $edu?->qualification)); ?>"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                    </div>
                </div>
                ...
                <div id="panel-profession" class="tab-panel hidden bg-white shadow-sm rounded-lg p-6">
                    ...
                    <?php $pro = $believer->profession; ?>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Profession</label>
                            <input type="text" name="profession[profession]" value="<?php echo e(old('profession.profession', $pro?->profession)); ?>"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Fonction</label>
                            <input type="text" name="profession[function]" value="<?php echo e(old('profession.function', $pro?->function)); ?>"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Entreprise</label>
                            <input type="text" name="profession[company]" value="<?php echo e(old('profession.company', $pro?->company)); ?>"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Contact professionnel</label>
                            <input type="text" name="profession[professional_contact]" value="<?php echo e(old('profession.professional_contact', $pro?->professional_contact)); ?>"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                    </div>
                </div>
                ...
                <div id="panel-responsabilite" class="tab-panel hidden bg-white shadow-sm rounded-lg p-6">
                    ...
                    <?php $resp = $believer->responsibility; ?>
                    <div class="space-y-4">
                        <div>
                            ...
                            <textarea name="responsibility[old]" rows="2"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"><?php echo e(old('responsibility.old', $resp?->old)); ?></textarea>
                        </div>
                        <div>
                            ...
                            <textarea name="responsibility[current]" rows="2"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"><?php echo e(old('responsibility.current', $resp?->current)); ?></textarea>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Souhaits de service</label>
                            <textarea name="responsibility[desire]" rows="2"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"><?php echo e(old('responsibility.desire', $resp?->desire)); ?></textarea>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-2">
                            ...
                            <label class="flex items-center gap-2 text-sm cursor-pointer">
                                <input type="checkbox" name="teams[]" value="<?php echo e($team->id); ?>"
                                    <?php if(in_array($team->id, old('teams', $believer->teams->pluck('id')->toArray()))): echo 'checked'; endif; ?>
                                    class="rounded border-gray-300 text-indigo-600">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-2">
                            ...
                            <label class="flex items-center gap-2 text-sm cursor-pointer">
                                <input type="checkbox" name="worship_groups[]" value="<?php echo e($group->id); ?>"
                                    <?php if(in_array($group->id, old('worship_groups', $believer->worshipGroups->pluck('id')->toArray()))): echo 'checked'; endif; ?>
                                    class="rounded border-gray-300 text-indigo-600">
                    ...
                    <div>
                        ...
                        <select name="cell_id" class="mt-1 block w-full md:w-1/2 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                            ...
                            <?php $__currentLoopData = $cells; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cell): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($cell->id); ?>"
                                    <?php if(old('cell_id', $believer->cells->first()?->id) == $cell->id): echo 'selected'; endif; ?>>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ekklesia-gestion\resources\views/believers/edit.blade.php ENDPATH**/ ?>