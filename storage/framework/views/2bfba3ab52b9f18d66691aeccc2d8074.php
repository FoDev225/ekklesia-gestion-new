...
<?php $__env->startSection('title', $worshipGroup->name); ?>
<?php $__env->startSection('page-title', 'Détail du groupe de louange'); ?>
...
<div class="space-y-4">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
            ...
            <a href="<?php echo e(route('worship-groups.index')); ?>" class="text-sm text-gray-500 hover:text-gray-700">Groupes de louange</a>
            <span class="text-gray-300">/</span>
            <span class="text-sm text-gray-700 font-medium"><?php echo e($worshipGroup->name); ?></span>
        </div>
    ...
    <div class="bg-white shadow-sm rounded-lg p-4 flex items-center justify-between">
        <div>
            <h2 class="text-lg font-bold text-gray-900"><?php echo e($worshipGroup->name); ?></h2>
        </div>
        <a href="<?php echo e(route('worship-groups.members-pdf', $worshipGroup)); ?>"
           class="inline-flex items-center px-4 py-2 text-white text-sm font-medium rounded-md"
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
        <div class="bg-white rounded-lg p-4 shadow-sm border-l-4" style="border-color:#3FA46A">
            ...
            <p class="text-2xl font-bold mt-1" style="color:#3FA46A"><?php echo e($worshipGroup->believers->count()); ?></p>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div class="md:col-span-2 space-y-4">
            ...
            <div class="bg-white shadow-sm rounded-lg p-4">
                ...
                <p class="text-sm text-gray-600">
                    ...
                    <?php echo e($worshipGroup->description ?: '—'); ?>
            ...
            <div class="bg-white shadow-sm rounded-lg overflow-hidden">
                <div class="px-4 py-3 border-b border-gray-200">
                    <h3 class="text-sm font-semibold text-gray-700 uppercase">Membres du groupe de louange</h3>
                </div>
                <table class="min-w-full divide-y divide-gray-200 text-sm">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__empty_1 = true; $__currentLoopData = $worshipGroup->believers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $believer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 text-center whitespace-nowrap">
                                <form action="<?php echo e(route('worship-groups.believers.destroy', [$worshipGroup, $believer])); ?>" method="POST"
                                      onsubmit="return confirm('Retirer ce membre du groupe de louange ?');">
                                    <?php echo csrf_field(); ?>
        ...
        <div class="md:col-span-1">
            <div class="bg-white shadow-sm rounded-lg p-4">
                ...
                <form action="<?php echo e(route('worship-groups.believers.store', $worshipGroup)); ?>" method="POST" class="space-y-3">
                    <?php echo csrf_field(); ?>
                    <div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ekklesia-gestion\resources\views/worship-groups/show.blade.php ENDPATH**/ ?>