...
<?php $__env->startSection('page-title', 'Gestion des groupes'); ?>
...
<div class="space-y-4">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
            ...
            <span class="text-sm text-gray-700 font-medium">Groupes</span>
        </div>
    ...
    <div class="bg-white shadow-sm rounded-lg p-4">
        <form method="GET" action="<?php echo e(route('groups.index')); ?>"
            ...
            <span class="col-span-2 md:col-span-4 text-sm text-gray-500 text-right">
                <?php echo e($groups->total()); ?> groupe(s)
            </span>
        </form>
    </div>
        ...
        <table class="min-w-full divide-y divide-gray-200 text-sm">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    <td class="px-4 py-3 font-medium text-gray-900"><?php echo e($group->name); ?></td>
                    <td class="px-4 py-3 text-gray-600"><?php echo e(Str::limit($group->description, 40) ?: '—'); ?></td>
                    ...
                    <td class="px-4 py-3 text-gray-600">
                        <span class="text-xs px-1.5 py-0.5 bg-blue-100 text-blue-600 rounded">
                            <?php echo e($group->believers_count); ?>
                    ...
                    <td class="px-4 py-3 text-center whitespace-nowrap space-x-1">
                        ...
                        <button type="button"
                            onclick="openDeleteModal('<?php echo e(route('groups.destroy', $group)); ?>', '<?php echo e($group->name); ?>')"
    ...
    <div id="deleteModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div class="bg-white rounded-lg p-6 w-full max-w-sm">
            <div class="flex items-center gap-3 mb-4">
                ...
                <h3 class="text-sm font-semibold text-gray-900">Supprimer le groupe</h3>
            </div>
    ...
    <script>
        function openDeleteModal(actionUrl, groupName) {
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ekklesia-gestion\resources\views/groups/index.blade.php ENDPATH**/ ?>