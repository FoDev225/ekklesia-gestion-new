...
<div class="max-w-5xl mx-auto space-y-4">
    ...
    <div class="py-8">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('believers.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div id="panel-general" class="tab-panel bg-white shadow-sm rounded-lg p-6 space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="nationality" value="{{ old('nationality', 'Ivoirienne') }}"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="number_of_children" value="{{ old('number_of_children', 0) }}" min="0"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                ...
                <div id="panel-adresse" class="tab-panel hidden bg-white shadow-sm rounded-lg p-6 space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="address[sous_quartier]" value="{{ old('address.sous_quartier') }}"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700">Téléphone</label>
                            <input type="text" name="address[phone]" value="{{ old('address.phone') }}"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700">WhatsApp</label>
                            <input type="text" name="address[whatsapp]" value="{{ old('address.whatsapp') }}"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700">Email</label>
                            <input type="email" name="address[email]" value="{{ old('address.email') }}"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                ...
                <div id="panel-eglise" class="tab-panel hidden bg-white shadow-sm rounded-lg p-6 space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="church[original_church]" value="{{ old('church.original_church') }}"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700">Année d'arrivée</label>
                            <input type="number" name="church[arrival_year]" value="{{ old('church.arrival_year') }}"
                                min="1900" max="{{ date('Y') }}"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="date" name="church[conversion_date]" value="{{ old('church.conversion_date') }}"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700">Lieu de conversion</label>
                            <input type="text" name="church[conversion_place]" value="{{ old('church.conversion_place') }}"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        ...
                        <div id="baptism-fields" class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4 {{ old('church.baptised') ? '' : 'hidden' }}">
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Date de baptême</label>
                                <input type="date" name="church[baptism_date]" value="{{ old('church.baptism_date') }}"
                                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Lieu de baptême</label>
                                <input type="text" name="church[baptism_place]" value="{{ old('church.baptism_place') }}"
                                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Pasteur officiant</label>
                                <input type="text" name="church[baptism_pastor]" value="{{ old('church.baptism_pastor') }}"
                                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">N° carte de baptême</label>
                                <input type="text" name="church[baptism_card_number]" value="{{ old('church.baptism_card_number') }}"
                                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="education[niveau_etude]"
                                ...
                                @foreach(['Primaire','Secondaire','Baccalauréat','Licence','Master','Doctorat','Aucun'] as $n)
                                    <option value="{{ $n }}" @selected(old('education.niveau_etude') === $n)>{{ $n }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Diplôme obtenu</label>
                            <input type="text" name="education[diploma]" value="{{ old('education.diploma') }}"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Qualification / Spécialité</label>
                            <input type="text" name="education[qualification]" value="{{ old('education.qualification') }}"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                    </div>
                </div>
                ...
                <div id="panel-profession" class="tab-panel hidden bg-white shadow-sm rounded-lg p-6 space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="profession[profession]" value="{{ old('profession.profession') }}"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Fonction</label>
                            <input type="text" name="profession[function]" value="{{ old('profession.function') }}"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Entreprise / Structure</label>
                            <input type="text" name="profession[company]" value="{{ old('profession.company') }}"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Contact professionnel</label>
                            <input type="text" name="profession[professional_contact]" value="{{ old('profession.professional_contact') }}"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <textarea name="responsibility[old]" rows="2"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">{{ old('responsibility.old') }}</textarea>
                        </div>
                        <div>
                            ...
                            <textarea name="responsibility[current]" rows="2"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">{{ old('responsibility.current') }}</textarea>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Souhaits de service</label>
                            <textarea name="responsibility[desire]" rows="2"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">{{ old('responsibility.desire') }}</textarea>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-2">
                            ...
                            <label class="flex items-center gap-2 text-sm cursor-pointer">
                                <input type="checkbox" name="worship_groups[]" value="{{ $group->id }}"
                                    @checked(in_array($group->id, old('worship_groups', [])))
                                    class="rounded border-gray-300 text-indigo-600">
                                {{ $group->name }}
                            </label>
                            @endforeach
