...
@section('title', $worshipGroup->name)
@section('page-title', 'Détail du groupe de louange')
...
<div class="space-y-4">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
            ...
            <span class="text-gray-300">/</span>
            <span class="text-sm text-gray-700 font-medium">{{ $worshipGroup->name }}</span>
        </div>
    ...
    <div class="bg-white shadow-sm rounded-lg p-4 flex items-center justify-between">
        <div>
            <h2 class="text-lg font-bold text-gray-900">{{ $worshipGroup->name }}</h2>
        </div>
        <a href="{{ route('worship-groups.members-pdf', $worshipGroup) }}"
           class="inline-flex items-center px-4 py-2 text-white text-sm font-medium rounded-md"
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
        <div class="bg-white rounded-lg p-4 shadow-sm border-l-4" style="border-color:#3FA46A">
            ...
            <p class="text-2xl font-bold mt-1" style="color:#3FA46A">{{ $worshipGroup->believers->count() }}</p>
        </div>
            ...
            <div class="bg-white shadow-sm rounded-lg overflow-hidden">
                ...
                <table class="min-w-full divide-y divide-gray-200 text-sm">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse ($worshipGroup->believers as $believer)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 text-center whitespace-nowrap">
                                <form action="{{ route('worship-groups.believers.destroy', [$worshipGroup, $believer]) }}" method="POST"
