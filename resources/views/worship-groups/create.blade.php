...
@section('title', 'Nouveau groupe de louange')
@section('page-title', 'Nouveau groupe de louange')
...
<div class="space-y-4">
    ...
    <div class="bg-white shadow-sm rounded-lg p-6 max-w-2xl">
        <form action="{{ route('worship-groups.store') }}" method="POST" class="space-y-4">
            @csrf
            @include('worship-groups._form', ['worshipGroup' => null])
