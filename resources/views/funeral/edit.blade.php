...
@section('title', 'Modifier enregistrement')
...
<div class="max-w-3xl mx-auto space-y-4">
    ...
    <div class="flex items-center gap-3">
        ...
        <span class="text-gray-300">/</span>
        <a href="{{ route('funeral.show', $funeral) }}"
           class="text-sm text-gray-500 hover:text-gray-700">{{ $funeral->deceased_full_name }}</a>
        <span class="text-gray-300">/</span>
    ...
    <form method="POST" action="{{ route('funeral.update', $funeral) }}">
        @csrf @method('PUT')
        ...
        <div class="bg-white shadow-sm rounded-lg p-6 space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700">Lien de parenté <span class="text-red-500">*</span></label>
                    <select name="family_relationship" required
                        ...
                        <option value="pere"   @selected(old('family_relationship', $funeral->family_relationship) === 'pere')>Père</option>
                        <option value="mere"   @selected(old('family_relationship', $funeral->family_relationship) === 'mere')>Mère</option>
                        <option value="enfant" @selected(old('family_relationship', $funeral->family_relationship) === 'enfant')>Enfant biologique</option>
                    </select>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="date" name="death_date"
                        value="{{ old('death_date', $funeral->death_date?->format('Y-m-d')) }}"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm text-sm focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="burial_place"
                ...
                <div>
                    ...
                    <input type="date" name="funeral_date"
                        value="{{ old('funeral_date', $funeral->funeral_date?->format('Y-m-d')) }}"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm text-sm focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                <div class="md:col-span-2">
        ...
        <div class="bg-white shadow-sm rounded-lg p-6 space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700">Nombre de pagnes <span class="text-red-500">*</span></label>
                    <input type="text" name="loincloths_number"
                        value="{{ old('loincloths_number', $funeral->loincloths_number) }}"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm text-sm focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">Montant versé (FCFA) <span class="text-red-500">*</span></label>
        ...
        <div class="bg-white shadow-sm rounded-lg p-6 space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700">Nombre de pagnes</label>
                    <input type="text" name="nbre_pagne"
