...
<div class="church-header">
    <div class="church-header-logo">
        ...
        @else
            <div class="logo-placeholder">{{ $church->organisation }}</div>
        @endif
    </div>
    <div class="church-header-info">
        <div class="org-name">{{ $church->organisation_name }}</div>
        <div class="district">{{ $church->district }} - EGLISE LOCALE {{ $church->church_name }}</div>
        <div class="authorization">Autorisation N° : {{ $church->authorization }}</div>
    </div>
</div>
...
<div class="church-footer">
    <div class="footer-temple">
        Temple de {{ $church->church_name }}
    </div>
    <div class="footer-contact">
        {{ $church->contact_line }}
        @if($church->localisation)
            <br>Situation géographique : {{ $church->localisation }}
        @endif
    </div>
