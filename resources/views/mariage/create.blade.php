...
<div class="max-w-4xl mx-auto space-y-4">
    ...
    <form method="POST" action="{{ route('mariage.store') }}" enctype="multipart/form-data">
        ...
        <div class="bg-white shadow-sm rounded-lg p-6 space-y-4">
            ...
            {{-- Sélection fidèle — visible uniquement si "Fidèle de l'église" --}}
            <div id="groom_believer_fields" class="{{ old('groom_type', 'believer') === 'external' ? 'hidden' : '' }}">
            ...
            {{-- Champs manuels — visibles UNIQUEMENT si "Externe à l'église" --}}
            <div id="groom_details_fields" class="grid grid-cols-1 md:grid-cols-2 gap-4 {{ old('groom_type', 'believer') !== 'external' ? 'hidden' : '' }}">
                <div>
                ...
                <div>
                    ...
                    <input type="date" name="groom_birthdate" value="{{ old('groom_birthdate') }}"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm text-sm focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">Lieu de naissance</label>
                    <input type="text" name="groom_birth_place" value="{{ old('groom_birth_place') }}"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm text-sm focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">Date de baptême</label>
                    <input type="date" name="groom_bapistism_date" value="{{ old('groom_bapistism_date') }}"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm text-sm focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">Lieu de baptême</label>
                    <input type="text" name="groom_bapistism_place" value="{{ old('groom_bapistism_place') }}"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm text-sm focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">Pasteur du baptême</label>
                    <input type="text" name="baptism_officer_groom" value="{{ old('baptism_officer_groom') }}"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm text-sm focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">Profession</label>
                    <input type="text" name="groom_profession" value="{{ old('groom_profession') }}"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm text-sm focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                <div>
        ...
        <div class="bg-white shadow-sm rounded-lg p-6 space-y-4">
            ...
            <div id="bride_believer_fields" class="{{ old('bride_type', 'believer') === 'external' ? 'hidden' : '' }}">
            ...
            <div id="bride_details_fields" class="grid grid-cols-1 md:grid-cols-2 gap-4 {{ old('bride_type', 'believer') !== 'external' ? 'hidden' : '' }}">
                <div>
                    <label class="block text-sm font-medium text-gray-700">Nom & Prénom <span class="text-red-500">*</span></label>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700">Date de naissance</label>
                    <input type="date" name="bride_birthdate" value="{{ old('bride_birthdate') }}"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm text-sm focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">Lieu de naissance</label>
                    <input type="text" name="bride_birth_place" value="{{ old('bride_birth_place') }}"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm text-sm focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">Date de baptême</label>
                    <input type="date" name="bride_bapistism_date" value="{{ old('bride_bapistism_date') }}"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm text-sm focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">Lieu de baptême</label>
                    <input type="text" name="bride_bapistism_place" value="{{ old('bride_bapistism_place') }}"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm text-sm focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">Pasteur du baptême</label>
                    <input type="text" name="baptism_officer_bride" value="{{ old('baptism_officer_bride') }}"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm text-sm focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">Profession</label>
                    <input type="text" name="bride_profession" value="{{ old('bride_profession') }}"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm text-sm focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">Photo</label>
