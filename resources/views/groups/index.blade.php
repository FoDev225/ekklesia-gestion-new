            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-4 py-3 text-center whitespace-nowrap space-x-1">
                        ...
                        @can('groups.delete')
                        <button type="button"
                            onclick="openDeleteModal('{{ route('groups.destroy', $group) }}', '{{ $group->name }}')"
