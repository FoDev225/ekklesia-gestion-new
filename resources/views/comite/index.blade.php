...
@section('title', 'Comité de l\'église')
@section('page-title', 'Comité de gestion')
...
<div class="space-y-4">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
            ...
            <span class="text-sm text-gray-700 font-medium">Comité</span>
        </div>
        <a href="{{ route('comite.meetings') }}"
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div class="md:col-span-2 space-y-4">
            ...
            <div class="bg-white shadow-sm rounded-lg overflow-hidden">
                <div class="px-4 py-3 border-b border-gray-200" style="background:#3A9BDC">
                    <h3 class="text-sm font-semibold text-white uppercase">Comité de l'église</h3>
                </div>
                <table class="min-w-full divide-y divide-gray-200 text-sm">
                    <thead class="bg-gray-50">
                        <tr>
                            <th class="px-4 py-3 text-left font-medium text-gray-500 uppercase">Nom</th>
                            <th class="px-4 py-3 text-left font-medium text-gray-500 uppercase">Fonction (comité)</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 text-gray-500">
                            ...
                            <td class="px-4 py-3 text-center">
                                <form action="{{ route('comite.reactivate', $member) }}" method="POST" class="inline">
                                    @csrf @method('PATCH')
        ...
        <div class="md:col-span-1">
            <div class="bg-white shadow-sm rounded-lg p-4">
                ...
                <form action="{{ route('comite.store') }}" method="POST" class="space-y-3">
                    @csrf
                    <div>
                    ...
                    <div>
                        ...
                        <select name="role" required
                            class="w-full border-gray-300 rounded-md text-sm focus:ring-indigo-500 focus:border-indigo-500">
                            <option value="">— Sélectionner —</option>
                            @foreach(\App\Models\Comite::ROLES_GESTION as $r)
